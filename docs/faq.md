...
Core selection still uses your patterns. The optional 1.8.4 knowledge layer
...
No. The immutable `v1.8.4` Production/Stable release is installed from its
...
The historical `v0.2.0` Release has none. The immutable `v1.8.4` Release has
exactly `opencntx-1.8.4-py3-none-any.whl`,
`opencntx-1.8.4.tar.gz`, `SHA256SUMS`, and `BUILD-RECORD.json`. Locally built
...
[1.8.4 release roadmap](roadmap-1.8.4.md), [1.8.4 release scope](release-1.8.4.md),
