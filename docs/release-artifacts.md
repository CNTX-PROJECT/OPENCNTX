...
python tools/release_artifacts.py verify --directory dist --expected-version 1.4.0 --expected-commit $commit --expected-tree $tree
```
...
python3 tools/release_artifacts.py verify --directory dist --expected-version 1.4.0 --expected-commit "$commit" --expected-tree "$tree"
```
...
```powershell
python tools/release_artifacts.py smoke --artifact dist\opencntx-1.4.0-py3-none-any.whl --expected-version 1.4.0
python tools/release_artifacts.py smoke --artifact dist\opencntx-1.4.0.tar.gz --expected-version 1.4.0
```
