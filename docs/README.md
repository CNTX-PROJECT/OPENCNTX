...
| You need… | Read |
|---|---|
| Installation, a first package, updates or removal | [Install and update 1.8.1](install-and-update.md) · [Get started](start-here.md) |
| A short explanation of the product | [How it works](how-it-works.md) · [Knowledge layer](knowledge-layer.md) |
| The latest development plan | [1.8.1 release roadmap](roadmap-1.8.1.md); [1.8.0 release roadmap](roadmap-1.8.0.md); [Roadmap](roadmap.md); [complete historical plan](roadmap-plan.md) |
...
Current software: **v1.8.1**. See the [1.8.1 release scope](release-1.8.1.md)
...
- [1.8.1 release scope](release-1.8.1.md) · [1.8.1 roadmap](roadmap-1.8.1.md) · [1.8.0 release scope](release-1.8.0.md) — delivered behavior and release gates.
