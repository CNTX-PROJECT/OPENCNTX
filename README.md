...
**v1.1.1** · **Local first** · **Any model** · **Zero runtime dependencies**
...
`pipx` installed, install the exact v1.1.1 release in one command:
...
| Item | Proven state |
|---|---|
| Release | `v1.1.1` Production/Stable, immutable GitHub Release; `v1.1.0` and `v1.0.0` remain immutable |
| Package | `opencntx 1.1.1` |
...
- `opencntx-1.1.1-py3-none-any.whl`
- `opencntx-1.1.1.tar.gz`
- `SHA256SUMS`
- `BUILD-RECORD.json`
