...
`pipx` installed, install the exact v1.7.1 release in one command:
...
```powershell
git clone --branch v1.7.1 --depth 1 https://github.com/CNTX-PROJECT/OPENCNTX.git
cd OPENCNTX
...
The v1.7.1 release distribution requires exactly:
