...
OPENCNTX packages and verifies files. The current release also provides a local knowledge
...
guide](docs/knowledge-layer.md). It does not run an AI or interpret chat intent. Version 1.8.5 adds optional compact search output. The [release scope](docs/release-1.8.5.md) records its delivered behavior and original qualification limits.
